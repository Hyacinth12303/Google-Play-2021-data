...
# Conclusions Page
    ...
    st.write("The application explores the Android game market dataset using two machine learning models: Random Forest Regression and Decision Tree Regression in order to understand the factors that makes the game deserve the top rank in Google Play Store.") 


    st.write("It is concluded that the most important features when predicting the average rating of the game is its total number of 5 stars and 1 star per title. It is also concluded that the most important factor when assigning a rank to a title are the number of ratings it contains and how many of the ratings contain 5 stars per category. It is also noted that a game should be accessible to everyone, meaning the game has to be free in order for more people to try and play the game. It had nothing to do with how many people installed the game and the growth of the game in under a month or 2. In conclusion, the most important thing when it comes to making a game is to make the game very impactful for people to entice them to rate the game, since a good rating is what essentially brings the game to the top, it had nothing much to do in how active are the people playing the game.")
